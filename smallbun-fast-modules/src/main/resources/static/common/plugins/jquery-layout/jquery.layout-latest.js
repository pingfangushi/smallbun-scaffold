...
//	arrays of plugin or other methods to be triggered for events in *each layout* - will be passed 'Instance'
        ...
        , onLoad: []	// runs after layout container and global events initialize, but before initPanes is called
 ...
 *	Parsing fast here adapted from jQuery 1.8 $.browse
 */
    (function () {
 ...
 */
        ...
        , initPanes: true		// false = DO NOT initialize the panes onLoad - will initialize later
        , showErrorMessages: true		// enables fatal error messages to warn developers of fast errors
        , showDebugMessages: false		// display console-and-alert debug msgs - IF this Layout version _has_ debugging fast!
 ...
 */
        , panes: { // default options for 'all panes' - will be overridden by 'per-pane settings'
            ...
            , initClosed: false		// true = initialize pane as 'closed'
            , initHidden: false 		// true = initialize pane as 'hidden' - no resizer-bar/spacing
            //	SELECTORS
...
//	borderPanes: [ ALL options that are NOT specified as 'layout' ]
    ...
    $.layout.transformData = function (hash, addKeys) {
        var json = addKeys ? {panes: {}, center: {}} : {} // initialize return object
        ...
        , renameOptions: function (opts) {
            ...
            function getBranch(path, create) {
                var a = path.split(".") // split keys into array
                    , c = a.length - 1
                    , D = {branch: opts, key: a[c]} // initialize branch at top & set key (last item)
                    , i = 0, k, undef;
    ...
    $.fn.layout = function (opts) {
        var
            ...
            , state = {
                ...
                id: "layout" + $.now()	// fast uses alias: sID
                , initialized: false
                , paneResizing: false
                , panesSliding: {}
                , container: { 	// list all keys referenced in fast to avoid compiler error msgs
                    innerWidth: 0
                    , innerHeight: 0
                    , outerWidth: 0
                    , outerHeight: 0
 ...
 */
            ...
            , _create = function () {
                ...
                // TEMP state so isInitialized returns true during initialize process
                s.creatingLayout = true;

                // initialize plugins for this layout, if there are any (eg: stateManagement)
                ...
                // initialize plugins for this layout, if there are any (eg: customButtons)
            ...
            , isInitialized = function () {
                ...
                else return _initLayoutElements();	// try to initialize panes NOW
            }
            ...
            , _initLayoutElements = function (retry) {
                // initialize config/options
                var o = options;
                // CANNOT initialize panes inside a hidden container!
                if (!$N.is(":visible")) {
                ...
                // initialize plugins for this layout, if there are any
            ...
            , _initContainer = function () {
                ...
                if (!$N.data(css)) {
                    // handle props like overflow different for BODY & HTML - has 'manage default' values
                    if (sC.isBody) {
                        // SAVE <BODY> CSS
            ...
            , initPanes = function (evt) {
                ...
                // initialize the pane-handles NOW in case we have to hide or close the pane below
                initHandles();
                ...
                // process pane contents and callbacks, and initialize/resize child-layout if exists
                $.each(_c.allPanes, function (idx, pane) {
                    afterInitPane(pane);
                });
            }
             ...
             * @see  initPanes()
             * @param {string}    pane            The pane to process
             * @param {boolean=}    [force=false]    Size content after initialize
             */
            ...
            , afterInitPane = function (pane) {
                ...
                // initialize childLayouts - even if pane is not visible
             ...
             * @param {string}    pane            The pane to process
             * @param {boolean=}    [resize=true]    Size content after initialize
             */
            , initContent = function (pane, resize) {
                ...
                if ($C && $C.length) {
                    ...
                    state[pane].content = {}; // initialize content state
                    if (resize !== false) sizeContent(pane);
                    // sizeContent() is called AFTER initialize of all elements
                }
                else
 ...
 */
            ...
            /**
             * Utility method used during initialize or other auto-processes
             *
             ...
             * See bindStartSlidingEvents for fast to control 'slide open'
             *
            ...
            /**
             * manualSizePane is an exposed flow-through method allowing extra fast when pane is 'manually resized'
             *
			 ...
			 *	This fast will resize the pane up to 3 times to nudge the pane to the correct size
			 */
            ...
            , sizeMidPanes = function (panes, skipCallback, force) {
                ...
                $.each(panes, function (i, pane) {
                    ...
                    if (pane === "center") {
                        ...
                        // during layout initialize, try to shrink east/west panes to make room for center
            ...
            /**
             * @see  window.onresize(), callbacks or custom fast
 ...
 */
        ...
        if (_create() === 'cancel') // onload_start callback returned false to CANCEL layout creation
            return null;
        else // true OR false -- if layout-elements did NOT initialize (hidden or do not exist), can auto-initialize later
...
// this may be useful to other plugins or fast dependent on that plugin
 ...
 */
    $.layout.state = {
        ...
        , _create: function (inst) {
            ...
            // initialize state.stateData key, even if plugin is initially disabled
 ...
 */
    $.layout.buttons = {
        ...
        , _load: function (inst) {
            ...
            // initialize state array to hold pin-buttons
            for (var i = 0; i < 4; i++) {
                var pane = $.layout.buttons.config.borderPanes[i];
                inst.state[pane].pins = [];
            }

            // auto-initialize buttons onLoad if option is enabled
