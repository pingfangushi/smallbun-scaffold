...
```
smallbun
├─smallbun-fast-common     公共模块
│ 
├─smallbun-fast-config     配置模块   
│ 
├─smallbun-fast-core       核心模块
│ 
├─smallbun-fast-generator  代码生成器
│        └─resources 
│           ├─mapper   MyBatis文件
...
│
├─smallbun-fast-entity      数据实体
│     
├─smallbun-fast-mapper      数据访问模块
│    └─resources 
│        ├─mapper   MyBatis文件
│ 
├─smallbun-fast-service     业务模块
│ 
├─smallbun-fast-web         控制器模块
│    └─resources 
│        ├─static  静态资源
│        ├─view 系统页面
│        │    ├─modules     模块页面
