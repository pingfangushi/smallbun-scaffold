...
INSERT INTO `sys_menu` VALUES (1096016383835123713, 0, '0', '通知公告', 'fa fa-commenting-o', '#dddddd', 'notify', '1', 'manage:notify:index', 0, NULL, 0, 1, '2019-02-14 12:00:43', 1, '2019-02-26 13:03:16', 0, '');
...
INSERT INTO `sys_menu` VALUES (1102919774603685889, 8, '0,7,8', '导入', NULL, '#dddddd', NULL, '2', 'manage:dict:import', 9999, NULL, 0, 1, '2019-03-05 13:12:20', 1, '2019-03-05 13:12:20', 0, '');
INSERT INTO `sys_menu` VALUES (1102919925531521025, 8, '0,7,8', '导出', NULL, '#dddddd', NULL, '2', 'manage:dict:export', 9999, NULL, 0, 1, '2019-03-05 13:12:56', 1, '2019-03-05 13:12:56', 0, '');
...
CREATE TABLE `sys_notify`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `sys_notify_id_uindex`(`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '通知通告' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_notify_record`  (
  ...
  `read_flag` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '1' COMMENT '阅读标记 1未阅读，0阅读',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '通知通告发送记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_operate_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `sys_operate_log_id_uindex`(`id`) USING BTREE
...
INSERT INTO `sys_role` VALUES (1073957301490032642, '超级管理员', 'ROOT', 1, '0', '0', 0, 1, '2018-12-15 09:05:48', 1, '2019-03-05 13:14:23', '0', '');
...
INSERT INTO `sys_role_menu` VALUES (1073957301490032642, 1102919774603685889);
INSERT INTO `sys_role_menu` VALUES (1073957301490032642, 1102919925531521025);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', 'admin', 'admin', '$2a$10$K26/8HAGoW0jFe7Tofr8e.hT7/P42ZQLuHMlenOsGkl.m9Zt6Vpby', '管理员', 'https://oss.aliyuncs.com/aliyun_id_photo_bucket/default_beauty.jpg', '15621346836', '', '2689170096@qq.com', '2018-05-24', '', NULL, NULL, '0:0:0:0:0:0:0:1', '本地', '2019-03-07 13:23:40', '0', '0', '232399', 1, '2018-06-18 10:50:02', 1, '2019-03-07 21:23:40', '0', '');
