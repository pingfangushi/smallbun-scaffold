...
import static org.smallbun.framework.injector.enmus.SqlMethod.SELECT_DATA_SCOPE_MAPS;
 ...
 * @since 2018-06-13
 */
public class DataScopeLogicSelectMaps extends AbstractDataScopeLogicMethod {

	@Override
	public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
		SqlMethod sqlMethod = SELECT_DATA_SCOPE_MAPS;
		String sql = String.format(sqlMethod.getSql(), sqlSelectColumns(tableInfo, true), tableInfo.getTableName().concat(SPACE).concat(ALIAS),
