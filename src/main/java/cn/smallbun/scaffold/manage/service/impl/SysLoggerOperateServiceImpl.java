 ...
 */
@Service
public class SysLoggerOperateServiceImpl extends
                                         BaseServiceImpl<SysLoggerOperateMapper, SysLoggerOperateEntity>
    ...
    @Override
    public void recording(LogModel log) {
     ...
     */
    @Override
    public void recording(LogModel log, JoinPoint joinPoint) {
     ...
     */
    private SysLoggerOperateEntity getLog(LogModel log) {
        //记录日志
