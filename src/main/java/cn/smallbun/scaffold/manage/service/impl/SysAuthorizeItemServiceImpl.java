...
public class SysAuthorizeItemServiceImpl extends
                                         BaseServiceImpl<SysAuthorizeItemMapper, SysAuthorizeItemEntity>
    ...
    public SysAuthorizeItemEntity getById(Serializable id) {
        List<SysAuthorizeItemEntity> list = this.list().stream()
    ...
    public boolean updateById(SysAuthorizeItemEntity entity) {
        ...
        if (update) {
            List<SysAuthorizeItemEntity> list = this.list();
            //获取数据
            List<SysAuthorizeItemEntity> values = list.stream()
