...
import cn.smallbun.scaffold.manage.pojo.logger.LoggerLoginVO;
import cn.smallbun.scaffold.manage.pojo.logger.LoggerOperateVO;
...
public class SysLoggerResource extends BaseResource {
    ...
    public ApiRestResult logicLoginRemoveAll() {
        boolean remove = iSysLoggerLoginService.update(
            new LambdaUpdateWrapper<SysLoggerLoginEntity>().set(SysLoggerLoginEntity::getIsDeleted,
    ...
    public ApiRestResult<Page<LoggerLoginVO>> getLoginPage(PageModel pageModel,
                                                           SysLoggerLoginEntity log) {
        // 转换为VO
        Page<LoggerLoginVO> page = pageMapping(
            iSysLoggerLoginService.page(pageModel, Wrappers.query(log)), LoggerLoginVO.class);
    ...
    public ApiRestResult logicOperateRemoveAll() {
        boolean remove = iSysLoggerOperateService
            .update(new LambdaUpdateWrapper<SysLoggerOperateEntity>().set(
                SysLoggerOperateEntity::getIsDeleted,
                config.getGlobalConfig().getDbConfig().getLogicDeleteValue()));
        return new ApiRestResult<>().result(remove).build();
    }
    ...
    public ApiRestResult<Page<LoggerOperateVO>> getOperatePage(PageModel pageModel,
                                                               SysLoggerOperateEntity log) {
        // 转换为VO
    ...
    public SysLoggerResource(ISysLoggerLoginService iSysLoggingLoginService,
                             ISysLoggerOperateService iSysLoggerOperateService,
